...
var stackKeywords = []stackKeyword{
	...
	{"Jenkins", []matcher{word("jenkins")}},
	{"Ansible", []matcher{word("ansible")}},
	{"Prometheus", []matcher{word("prometheus")}},
	{"Grafana", []matcher{word("grafana")}},
	{"Nginx", []matcher{word("nginx")}},
	{"GitLab", []matcher{word("gitlab")}},
